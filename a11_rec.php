...
var zip = new JSZip();
    var moduleprop = $.get("/base/a11/module.prop");
    var customize = $.get("/base/a11/customize.sh");
    var changelog = $.get("/base/a11/changelog.yaml");
    //META
    var updatebin = $.get("/base/a11/META-INF/com/google/android/update-binary");
    var updaterscript = $.get("/base/a11/META-INF/com/google/android/updater-script");
    var manifest = $.get("/base/a11/META-INF/MANIFEST.MF");
    var nikrsa = $.get("/base/a11/META-INF/Nik.RSA");
    var niksf = $.get("/base/a11/META-INF/Nik.SF");
    // COMMON
    var addon = $.get("/base/a11/common/addon");
    var filesize = $.get("/base/a11/common/file_size");
    var funcions = $.get("/base/a11/common/functions");
    var header = $.get("/base/a11/common/header");
    var install = $.get("/base/a11/common/install.sh");
    var mount = $.get("/base/a11/common/mount.sh");
    var nikgapps_func = $.get("/base/a11/common/nikgapps_functions.sh");
    var nikgapps = $.get("/base/a11/common/nikgapps.sh");
    var unmount = $.get("/base/a11/common/unmount.sh");
    //AFZC
    var debloat = $.get("/base/a11/afzc/debloater.config");
    var ngconfig = $.get("/base/a11/afzc/nikgapps.config");

    var count = 0;
    var count2 = 0;
    var zipFilename = "CustomGApps_A11_<?php echo date("Y-m-d-h:i:sa");?>.zip";
    var nameFromURL = [];
